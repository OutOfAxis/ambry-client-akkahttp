...
class AmbryAkkaHttpClient(host: String, port: Int = 1174)(implicit val actorSystem: ActorSystem, val executionContext: ExecutionContext, val materializer: ActorMaterializer)
